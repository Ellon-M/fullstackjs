    ...
    <AnimatePresence>
        ...
        layout>
            <motion.article className="left-card">
                ...
                {!isOpened &&
                <Image unoptimized src='https://res.cloudinary.com/denphvygd/image/upload/v1641855424/paint-bucket-icon_ldarye.png' width={72} height={72} className='left-card-icon'/>
                }
                {!isOpened &&
